                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                           <form action="{{ route('product.store') }}" method="post" enctype="multipart/form">
                              ...
                              <input type="text" name="status" class="form-control" placeholder="1 for In Stock |0 for out of Stock">
                              </div>
                              <div class="mb-1">
                                  <button type="submit"  class="btn btn-primary">Add Product</button>
                                  <form action="{{ route('product.store.view') }}">
                                   <input type="submit" class="btn btn-warning" value="View Product" />
                                    </form>
                              </div>
